...
public class MonoAgent : Agent
{
    ...
    public HexAgentBehaviorType typeOfHex;

    //Hex Brains
    //A different brain will be used depending on the HexAgentBehaviorType selected
    [Header("NN Models")] public NNModel HexDyModel;
    ...
    /// <summary>
    /// Set up the agent based on the typeOfHex
    /// </summary>
    void SetAgentType()
    {
        ...
        switch (typeOfHex)
        {
            case HexAgentBehaviorType.HexAgentModel:
                {
                    behaviorParams.BehaviorName = "HexAgentModel"; //set behavior name
                    if (HexDyModel)
                        behaviorParams.Model = HexDyModel; //assign the model
