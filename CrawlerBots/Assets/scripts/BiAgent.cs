...
public class BiAgent : Agent
{
    ...
    [Header("NN Models")] public NNModel BiModel;
    ...
    void SetAgentType()
    {
        ...
        {
            case AgentBehaviorType.BiAgentModel:
                {
                    behaviorParams.BehaviorName = "BiAgentModel"; //set behavior name
                    if (BiModel)
                        behaviorParams.Model = BiModel; //assign the model
